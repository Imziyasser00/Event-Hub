  ...
  return (
    <div className=''>
      <div className='text-center w-full flex flex-col my-12 gap-6'>
        ...
        <p className='font-semibold text-lg w-4/5 md:w-2/5 mx-auto'>We've had the pleasure of working with industry-defining brands. These are just some of them.</p>
      </div>
      <div className='m-2 grid grid-cols-3 md:grid-cols-5 gap-16 justify-center text-center items-center'>
