      ...
      <div className="w-1/2">
        ...
        {!loading && eventData ? (
          <div className="p-8">
            ...
            <div className="w-5/6 mx-auto font-bold text-primary text-2xl border-b-2 pb-4 mt-4 border-primary">
              {eventData.eventName}
            </div>
            <div className="w-5/6 mx-auto mt-5 flex justify-between border-b-2 pb-6 border-primary">
              <div className="text-xl font-bold text-primary ">Price : </div>
              <div className="text-primary font-bold text-xl">
                {eventData.price} $
              </div>
            </div>
            <div className="w-5/6 mx-auto mt-5 flex justify-between border-b-2 border-primary pb-6">
            ...
            <div className="w-5/6 mx-auto mt-5">
              <a href="/ordered" className=" bg-primary text-center">
